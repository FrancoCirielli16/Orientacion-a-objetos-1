...
class UsuarioTest {
	...
	void buscarPropiedades() {
		...
		Propiedad P1 = this.U1.registrarPropiedad("F", "null", "null", moderada,100);
		P1.hacerReserva(periodo1, U1);
		P1.hacerReserva(periodo3, U1);
		Propiedad P2 = this.U1.registrarPropiedad("G", "null", "null",flexible,100);
		P2.hacerReserva(periodo2, U1);
		Propiedad P3 = this.U1.registrarPropiedad("M", "null", "null", estricta,100);
	...
	void testRegistrarPropiedad() {
		...
		this.U1.registrarPropiedad("F", "X", "X", flexible ,100);
		this.U1.registrarPropiedad("D", "X", "X", estricta,1000);
		this.U1.registrarPropiedad("S", "X", "X", moderada,1000);
		this.U1.registrarPropiedad("A", "X", "X", flexible,200);
	...
	void testCalcularIngreso() {
		Propiedad P1 = this.U1.registrarPropiedad("F", "null", "null", flexible,100);
		P1.hacerReserva(periodo1, U1);
	...
	void testObtenerReserva() {
		...
		Propiedad P2 = this.U1.registrarPropiedad("G", "null", "null", moderada,100);
		P2.hacerReserva(periodo2, U1);
		Propiedad P3 = this.U1.registrarPropiedad("M", "null", "null", estricta,100);
		P3.hacerReserva(periodo3, U1);
