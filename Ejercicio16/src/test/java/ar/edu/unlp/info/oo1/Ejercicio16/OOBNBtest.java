...
class OOBNBtest {
	...
	void testBuscarPropiedades() {
		...
		Propiedad P1 = U1.registrarPropiedad("F", "null", "null",flexible,100);
		P1.hacerReserva(periodo1, U1);
		P1.hacerReserva(periodo3, U1);
		Propiedad P2 = U1.registrarPropiedad("G", "null", "null",flexible,100);
		P2.hacerReserva(periodo2, U1);
		Propiedad P3 = U1.registrarPropiedad("M", "null", "null",flexible,100);
	...
	void testObtenerReserva() {
		Usuario U1 = this.booking.registrarUsuario("Franco", "C", 12341);
		Propiedad P1 = U1.registrarPropiedad("F", "null", "null",moderada,100);
